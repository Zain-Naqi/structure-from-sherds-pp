...
//         if (matches_.empty()) {
//             cout << "MATCHES ARE EMPTY...WHY?" << endl;
//             BuildOutputsFromSelection(vector<bool>());
//             return;
//         }
...
//             chromosome.genes.resize(matches_.size(), false);
//             chromosome.fitness = 0.0;

//             for (size_t gene_idx = 0; gene_idx < chromosome.genes.size(); ++gene_idx) {
//                 if ((static_cast<double>(rand()) / RAND_MAX) < kInitialPairActivationRate) {
//                     chromosome.genes[gene_idx] = true;
//                 }
//             }
//             RepairBinaryChromosome(chromosome);
...
//         for (size_t i = 0; i < child.genes.size(); ++i) {
//             child.genes[i] = (rand() % 2 == 0) ? parent1.genes[i] : parent2.genes[i];
//         }

//         RepairBinaryChromosome(child);
//         return child;
//     }
...
//                 last_mutated = static_cast<int>(i);
//             }
//         }
//         RepairBinaryChromosome(chromosome);
//         return last_mutated;
...
//     void RepairBinaryChromosome(Chromosome& chromosome) const
//     {
...
//             for (size_t match_idx : group) {
//                 if (chromosome.genes[match_idx]) {
//                     active_indices.push_back(static_cast<int>(match_idx));
//                     if (static_cast<int>(matches_[match_idx].inliner_) > max_inliner) {
//                         max_inliner = matches_[match_idx].inliner_;
//                         best_match_idx = static_cast<int>(match_idx);
//                     }
//                 }
//             }
...
//     void BuildOutputsFromSelection(const vector<bool>& genes)
//     {
//         graph_ = MatrixXd::Zero(num_shards_, num_shards_);
